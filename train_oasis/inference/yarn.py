...
import torch
from train_oasis.model.dit_yarn import DiT_models_yarn
...
def main(args):
    ...
    # load DiT checkpoint
    model = DiT_models_yarn[args.model_name]()
    ...
    assert actions.shape[1] == total_frames, f"open_oasis_generate: {actions.shape[1]} != {total_frames}"
    ...
    for i in tqdm(range(n_prompt_frames, total_frames)):
        ...
        for noise_idx in reversed(range(1, ddim_noise_steps + 1)):
            ...
            actions_input = actions[:, start_frame : i + 1]
...
if __name__ == "__main__":
    ...
    parse.add_argument(
        ...
        default="/scratch/gpfs/xh4421/data_xh/model_ckpts/minecraft_easy_predict_v_3epoch.bin",
    )
    parse.add_argument(
        "--model-name",
        type=str,
    ...
    parse.add_argument(
        ...
        default="/scratch/gpfs/xh4421/inference_outputs/yarn.mp4",
    )
    parse.add_argument(
        "--fps",
        type=int,
