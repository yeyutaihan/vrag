...
from train_oasis.model.yarn import LlamaYaRNScaledRotaryEmbedding
...
class SpatioTemporalDiTBlock(nn.Module):
    def __init__(
        ...
        mlp_ratio=4.0,
        is_causal=True,
        spatial_rotary_emb: Optional[Union[RotaryEmbedding, LlamaYaRNScaledRotaryEmbedding]] = None,
        temporal_rotary_emb: Optional[Union[RotaryEmbedding, LlamaYaRNScaledRotaryEmbedding]] = None,
    ):
        super().__init__()
...
class DiT_yarn(nn.Module):
    ...
    def __init__(
        ...
        self.spatial_rotary_emb = LlamaYaRNScaledRotaryEmbedding(dim=hidden_size // num_heads, max_position_embeddings=frame_h * frame_w, original_max_position_embeddings=frame_h * frame_w)
        self.temporal_rotary_emb = LlamaYaRNScaledRotaryEmbedding(dim=hidden_size // num_heads, max_position_embeddings=self.max_frames * 4, original_max_position_embeddings=self.max_frames)
